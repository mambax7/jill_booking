...
define("_MA_JILLBOOKIN_ADD_TIME", "New time");
define("_MA_JILLBOOKIN_JBT_SN", "Period number");
...
define("_MA_JILLBOOKIN_JBI_TITLE", "Room Name");
...
define("_MA_JILLBOOKIN_IMPORT_APM", "Fast import afternoon set period");
define("_MA_JILLBOOKIN_IMPORT_PLACE", "Fast import %s set time period (the period of \"%s\")");
define("_MA_JILLBOOKIN_N_TIME", "\"%s\" of Day");
define("_MA_JILLBOOKIN_BOOKING_TIME", "\"%s\" has been appointment times, can not be deleted.");
define("_MA_JILLBOOKIN_AM", "Morning");
